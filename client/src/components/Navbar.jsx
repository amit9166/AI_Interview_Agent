...
export default function Navbar(){
    ...
    return(
        ...
        <div className="bg-white flex justify-between items-center rounded-3xl border border-gray-200
        w-full max-w-6xl px-8 py-4 shadow-lg">
            ...
            <div className="flex items-center gap-6 ">
                <div className="relative">
                    ...
                    hover:bg-gray-200 transition"><BsCoin className="size-4"/> {userData?.credits ||0}</button>
                ...
                <div className="relative">
                    ...
                    {showUserPopup && (
                        <div className="absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50">
                            ...
                            <button onClick={handleLogout} className="w-full text-left text-sm py-2 flex items-center gap-2 text-red-500"> <HiOutlineLogout className="size-4"/>logout</button>
                        </div>
                    )}
                </div>
            </div>
