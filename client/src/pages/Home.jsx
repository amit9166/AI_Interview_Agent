            ...
            <div className="flex-1 px-6 py-20">
                ...
                <div className="flex justify-center mb-6">
                    <div className="bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2">
                        <HiSparkles className="size-{16} bg-green-50 text-green-500"/>
                ...
                <div>
                    <div className="text-center mb-28">
                        ...
                        animate={{opacity:1}}
                        transition={{duration:0.8}}                        
                        className="text-gray-500 mt-6 max-w-2xl mx-auto tex-lg">
                     ...
                     items-center gap-10 mb-28">
                        {
                            [
                                ...
                                },
                                {
                                    ...
                                    desc:"Real interbiew pressure with time tracking."
                                },
                            ].map((item,index)=>{
                                return(
                                <motion.div 
                                ...
                                key={index} className={`relative bg-white rounded-3xl border-2 border-green-100
                        ...
                        <div className="grid md:grid-cols-2 gap-10">
                            {
                                [
                                    ...
                                    key={index} className="bg-white border border-gray-200
                                    rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all">
                                        <div className="flex flex-col md:flex-row items-center gap-8">
                                            ...
                                            <div className="w-full md:w-1/2">
                                                <div className="bg-green-50 text-green-500 w-12 h-12 rounded-xl flex 
                                                items-center justify-center mb-6">{item.icon}</div>
