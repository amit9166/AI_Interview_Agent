  ...
  const plans=[
    {
      ...
      price:"₹0",
      credits:100,
      description:"Ideal for beginners to explore and practice with limited credits.",
      features:[
    ...
    },
    {
      ...
      price:"₹500",
      credits:650,
      description:"Best Value for serious candidates who want comprehensive preparation.",
      features:[
        ...
        {plans.map((plan)=>{
          ...
          return(
            ...
            className={`relative rounded-3xl p-8 transition-all duration-300 border
              ${isSelected ?" border-emerald-600 shadow-2xl bg-white"
            ...
            >
              ...
              {/* default Tag */}
              {plan.default && (
                <div className="absolute top-6 right-6 bg-gray-300
              ...
              {!plan.default &&
                ...
                className={`w-full mt-8 py-3 rounded-xl font-semibold transition
                  ...
                  }`}>{loadingPlan===plan.id ? "Processing..." : isSelected ? "Proceed to pay": "Select Plan"}</button>
              }
            </motion.div>
          )
        })}
